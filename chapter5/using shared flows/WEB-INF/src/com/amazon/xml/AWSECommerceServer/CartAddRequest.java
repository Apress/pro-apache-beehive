...
public class CartAddRequest  implements java.io.Serializable {
    ...
    private com.amazon.xml.AWSECommerceServer.CartAddRequestItems items;
    ...
    public CartAddRequest(
           ...
           com.amazon.xml.AWSECommerceServer.CartAddRequestItems items,
     ...
     * @return items
     */
    public com.amazon.xml.AWSECommerceServer.CartAddRequestItems getItems() {
        return items;
    }
     ...
     * @param items
     */
    public void setItems(com.amazon.xml.AWSECommerceServer.CartAddRequestItems items) {
        this.items = items;
    }
    ...
    static {
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://webservices.amazon.com/AWSECommerceService/2005-03-23", ">CartAddRequest>Items"));
        elemField.setMinOccurs(0);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
