...
public class CustomerContentSearchResponse  implements java.io.Serializable {
    ...
    private com.amazon.xml.AWSECommerceServer.Customers[] customers;

    public CustomerContentSearchResponse() {
    }

    public CustomerContentSearchResponse(
           com.amazon.xml.AWSECommerceServer.Customers[] customers,
     ...
     * @return customers
     */
    public com.amazon.xml.AWSECommerceServer.Customers[] getCustomers() {
        return customers;
    }
     ...
     * @param customers
     */
    public void setCustomers(com.amazon.xml.AWSECommerceServer.Customers[] customers) {
        this.customers = customers;
    }

    public com.amazon.xml.AWSECommerceServer.Customers getCustomers(int i) {
        return this.customers[i];
    }

    public void setCustomers(int i, com.amazon.xml.AWSECommerceServer.Customers _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://webservices.amazon.com/AWSECommerceService/2005-03-23", ">CustomerContentSearchResponse"));
