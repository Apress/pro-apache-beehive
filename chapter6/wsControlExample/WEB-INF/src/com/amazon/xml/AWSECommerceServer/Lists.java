...
public class Lists  implements java.io.Serializable {
    ...
    private com.amazon.xml.AWSECommerceServer.List[] list;

    public Lists() {
    }

    public Lists(
           com.amazon.xml.AWSECommerceServer.List[] list,
     ...
     * @return list
     */
    public com.amazon.xml.AWSECommerceServer.List[] getList() {
        return list;
    }
     ...
     * @param list
     */
    public void setList(com.amazon.xml.AWSECommerceServer.List[] list) {
        this.list = list;
    }

    public com.amazon.xml.AWSECommerceServer.List getList(int i) {
        return this.list[i];
    }

    public void setList(int i, com.amazon.xml.AWSECommerceServer.List _value) {
        this.list[i] = _value;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://webservices.amazon.com/AWSECommerceService/2005-03-23", ">Lists"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://webservices.amazon.com/AWSECommerceService/2005-03-23", "List"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://webservices.amazon.com/AWSECommerceService/2005-03-23", ">List"));
        elemField.setMinOccurs(0);
        typeDesc.addFieldDesc(elemField);
    }
