...
public class CartCreateRequest  implements java.io.Serializable {
    ...
    private com.amazon.xml.AWSECommerceServer.CartCreateRequestItems items;
    ...
    public CartCreateRequest(
           com.amazon.xml.AWSECommerceServer.CartCreateRequestItems items,
     ...
     * @return items
     */
    public com.amazon.xml.AWSECommerceServer.CartCreateRequestItems getItems() {
        return items;
    }
     ...
     * @param items
     */
    public void setItems(com.amazon.xml.AWSECommerceServer.CartCreateRequestItems items) {
        this.items = items;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://webservices.amazon.com/AWSECommerceService/2005-03-23", "CartCreateRequest"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://webservices.amazon.com/AWSECommerceService/2005-03-23", ">CartCreateRequest>Items"));
        elemField.setMinOccurs(0);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
